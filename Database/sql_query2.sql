...
(  num int AUTO_INCREMENT NOT NULL PRIMARY KEY , 
   ...
   price     int  NOT NULL,
   amount    smallint  NOT NULL 
  , FOREIGN KEY(userid) REFERENCES userTbl(userID)  -- foreign key, userid에 primary key가 설정되어 있어야..
);
...
INSERT INTO buyTbl VALUES(NULL, 'JYP', '모니터', '전자', 200, 1); -- error
...
INSERT INTO userTbl VALUES('LSG', '이승기', 1987, '서울', '011', '1111111', 182, '2008-8-8');
INSERT INTO userTbl VALUES('KBS', '김범수', 1895, '경남', '011', '2222222', 173, '2012-4-4');
...
ALTER TABLE buyTbl
	ADD CONSTRAINT FK_userTbl_buyTbl
	FOREIGN KEY (userID)
	REFERENCES userTbl (userID); -- error - BBK없음
...
INSERT INTO userTbl VALUES('KBS', '김범수', 1895, '경남', '011', '2222222', 173, '2012-4-4');
INSERT INTO userTbl VALUES('KKH', '김경호', 1871, '전남', '019', '3333333', 177, '2007-7-7');
INSERT INTO userTbl VALUES('BBK', '조용필', 1950, '경기', '011', '4444444', 166, '2009-4-4');
select * from userTbl;
